...
class Echo3D{
    let api_key="noisy-bonus-2765" //insert your echo3D API key here
    //echo3D endpoint
    var serverURL="https://api.echo3D.co/query?key="
    //websocket endpoint
     var websockURL="ws://api.echo3D.co/message-endpoint"
    //secure websocket endpoint
    // var websockURL="wss://api.echo3D.co/message-endpoint"
    //url web sessions
    ...
    func queryDatabase(api_key:String, completion: ([Entry]) -> ()){
        self.serverURL="https://api.echo3D.co/query?key="+api_key;
